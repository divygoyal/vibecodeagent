...
export async function GET(req: Request) {
    ...
    try {
        ...
        const result = await fetchXMentionsForDomain(validationData.domain);
        ...
        console.error('Public X embed data error:', error);
        return NextResponse.json({ error: 'Failed to load X embed data' }, { status: 500 });
    }
}
