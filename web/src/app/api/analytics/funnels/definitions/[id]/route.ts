...
export async function PUT(req: Request, { params }: { params: Promise<{ id: string }> }) {
    ...
    const response = await fetch(`${ADMIN_API_URL}/api/analytics/funnels/definitions/${id}?user_identifier=${encodeURIComponent(session.user.id)}`, {
        method: 'PUT',
        headers: {
        ...
        body: JSON.stringify({
            ...
            steps_json: Array.isArray(body.steps) ? JSON.stringify(body.steps) : undefined,
