...
import { fetchShareOverviewTopLinkOut } from '@/lib/shareOverviewData';
import {
...
export async function GET(
    ...
    const cacheKey = buildShareOverviewCacheKey('topLinkOut', token, context.share.propertyId, [
        request.range,
        request.startDate || '',
        request.endDate || '',
        request.filters,
    ...
    const data = await cachedFetch(cacheKey, SHARE_OVERVIEW_CACHE_TTL.topLinkOut, () => fetchShareOverviewTopLinkOut({
