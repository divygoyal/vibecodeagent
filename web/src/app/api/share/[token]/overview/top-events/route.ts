...
import { fetchShareOverviewTopEvents } from '@/lib/shareOverviewData';
import {
...
export async function GET(
    ...
    const cacheKey = buildShareOverviewCacheKey('topEvents', token, context.share.propertyId, [
        request.range,
        request.startDate || '',
        request.endDate || '',
        request.filters,
    ...
    const data = await cachedFetch(cacheKey, SHARE_OVERVIEW_CACHE_TTL.topEvents, () => fetchShareOverviewTopEvents({
