...
function DiscountBanner({ onDismiss }: { onDismiss: () => void }) {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-[60] bg-black/90 backdrop-blur-md border-b border-emerald-500/20">
            <div className="max-w-7xl mx-auto px-4 py-2 sm:py-2.5 flex items-center justify-center gap-3 sm:gap-4 text-xs sm:text-sm">
                <span className="text-zinc-400 hidden sm:inline">New here?</span>
                <span className="text-white font-medium">
                    <span className="hidden sm:inline">Get </span><strong className="text-emerald-400">20% off</strong><span className="hidden sm:inline"> your first month</span>
                </span>
                <button
                    onClick={handleCopy}
                    className="inline-flex items-center gap-1.5 px-3 py-1 sm:px-4 sm:py-1.5 rounded-lg bg-emerald-500/10 border border-emerald-500/20 hover:bg-emerald-500/20 transition-colors font-mono font-bold text-xs text-emerald-400 tracking-wider cursor-pointer"
                >
                    NEWBEE20
                ...
                <button
                    onClick={onDismiss}
                    className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 p-1.5 rounded-lg text-zinc-500 hover:text-white hover:bg-white/10 transition-colors cursor-pointer"
