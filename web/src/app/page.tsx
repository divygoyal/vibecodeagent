...
export default function Home() {
  ...
  // Cast session user to include provider for TypeScript
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        {!session ? (
          ...
          <div className="text-center pt-16">
            ...
            <div className="flex flex-col gap-3 fade-in fade-in-delay-3">
              <button
                onClick={() => signIn('github')}
                className="inline-flex items-center justify-center gap-3 bg-zinc-800/80 hover:bg-zinc-700/80 px-8 py-4 rounded-xl font-semibold transition-all hover:scale-[1.03] hover:shadow-lg hover:shadow-emerald-500/10 border border-zinc-700/50"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-3 bg-zinc-100 hover:bg-white text-zinc-900 px-8 py-4 rounded-xl font-semibold transition-all hover:scale-[1.03] hover:shadow-lg hover:shadow-emerald-500/10 border border-zinc-200"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 glass-card p-6 fade-in fade-in-delay-3">
                ...
                {githubLoading ? (
                  ...
                  <p className="text-zinc-600 text-sm">No activity data (Connect GitHub to see stats)</p>
                )}
              </div>
            ...
            <div className="glass-card p-6 fade-in fade-in-delay-5">
              ...
              {githubLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-6 text-center">
                  <p className="text-zinc-500 text-sm mb-1">No recent commits found.</p>
                  <p className="text-zinc-600 text-xs">Connect GitHub to see activity.</p>
                </div>
              )}
            </div>
          </div>
