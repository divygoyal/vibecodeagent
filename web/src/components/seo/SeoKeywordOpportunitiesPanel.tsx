...
export default function SeoKeywordOpportunitiesPanel({ keyword, siteUrl, queryRow }: SeoKeywordOpportunitiesPanelProps) {
    ...
    // Title-bar Ask AI — short context-rich prompt routed by the SHARED_RULES
    // FROM_SEO tag. Complements the in-card "Build fix plan with AI" link
    // (which carries the deeper recommendation-specific prompt). Different
    // entry points for different user intents: quick chat vs. detailed plan.
