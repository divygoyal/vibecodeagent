...
const CARD = 'rounded-xl border border-white/[0.06] bg-white/[0.02] overflow-hidden';

function ChartTooltip({ active, payload, label }: any) {
    if (!active || !payload?.length) return null;
    return (
        <div className="bg-[#0a0a12] border border-white/[0.1] rounded-xl px-3 py-2 shadow-2xl text-[11px]">
