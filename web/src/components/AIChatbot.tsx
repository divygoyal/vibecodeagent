            ...
            const res = await fetch('/api/ai-chat', {
                ...
                body: JSON.stringify({
                    ...
                    analyticsContext: analyticsData ? {
                        ...
                        topSources: analyticsData.sources?.slice(0, 10),
                        topPages: analyticsData.pages?.slice(0, 10),
                        topCountries: analyticsData.countries?.slice(0, 10),
                        devices: analyticsData.devices,
                        browsers: analyticsData.browsers?.slice(0, 8),
                        channels: analyticsData.channels?.slice(0, 8),
                        referrers: analyticsData.referrers?.slice(0, 8),
                        cities: analyticsData.cities?.slice(0, 8),
                        languages: analyticsData.languages?.slice(0, 5),
                    } : null,
                    seoContext: seoData ? {
                        kpis: seoData.kpis,
                        topQueries: seoData.queries?.slice(0, 10),
                        topPages: seoData.pages?.slice(0, 10),
