            ...
            <section id="dashboard" className="relative isolate overflow-hidden border-b border-white/[0.06] bg-black">
                ...
                <div className="relative mx-auto max-w-[1380px] px-4 pb-14 pt-24 sm:px-6 sm:pb-20 sm:pt-28 lg:px-8 lg:pb-24 lg:pt-36">
                    <div className="mx-auto max-w-[1040px] text-center">
                        {/* Product Hunt launch — official "Featured on Product Hunt"
                            badge paired with our daily-rank chip. PH retires the
                            dynamic top-post-badge endpoint after the launch window,
                        ...
                        <div className="mb-6 flex flex-wrap items-center justify-center gap-3">
                            ...
                            <div className="inline-flex items-center rounded-full border border-[#14C4E1]/25 bg-[#07131d]/80 px-3.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#dff9ff] shadow-[0_8px_24px_rgba(20,196,225,0.12)] backdrop-blur-sm sm:text-xs">
