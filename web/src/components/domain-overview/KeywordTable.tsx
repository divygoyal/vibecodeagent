          ...
          <thead>
            <tr className="border-b border-white/[0.04]">
              {['Keyword', 'Volume', 'Difficulty', 'Intent', 'Content Type', ''].map((h) => (
                <th
                  key={h || 'actions'}
                  className={`px-2 py-2.5 sm:px-4 sm:py-3 text-xs font-medium uppercase tracking-wider text-[var(--text-secondary)] ${
                    h === 'Difficulty' || h === 'Content Type' ? 'hidden sm:table-cell' : ''
                  }`}
                >
                  {h}
                </th>
              ...
              return (
                <Fragment key={kw.keyword}>
                  ...
                  >
                    ...
                    <td className="px-2 py-2.5 sm:px-4 sm:py-3 text-xs sm:text-sm font-medium text-[var(--text-primary)]">
                      {kw.volume.toLocaleString()}
                    </td>
                    <td className={`px-2 py-2.5 sm:px-4 sm:py-3 text-xs font-medium hidden sm:table-cell ${db.text}`}>
                      {kw.difficulty}
                    </td>
                    <td className={`px-2 py-2.5 sm:px-4 sm:py-3 text-xs font-medium ${intentColor(kw.intent)}`}>
                      {kw.intent}
                    </td>
                    <td className="px-2 py-2.5 sm:px-4 sm:py-3 text-xs sm:text-sm text-[var(--text-secondary)] hidden sm:table-cell">{kw.contentType}</td>
                    <td className="px-2 py-2.5 sm:px-4 sm:py-3">
                      <TableActionMenu
                        actions={[
                          {
                  ...
                  {expanded && (
                    <tr className="border-b border-white/[0.03]">
                      <td colSpan={6} className="px-2 py-2.5 sm:px-4 sm:py-3">
                        <motion.div
